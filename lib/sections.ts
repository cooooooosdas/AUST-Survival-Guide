...
export const SECTIONS: Section[] = [
  { slug: "tools",      title: "工具箱",     href: "/tools",        description: "学习生活常用网址",       group: "main", accent: "tertiary" },
  { slug: "microservices", title: "学校微服务", href: "/microservices", description: "教务处与校内官方入口", group: "main", accent: "primary" },
