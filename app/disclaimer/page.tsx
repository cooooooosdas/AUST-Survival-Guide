...
export default function DisclaimerPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      <h1 className="text-2xl md:text-3xl font-serif font-semibold text-text">免责声明</h1>
      ...
      <div className="space-y-10 leading-[1.8] text-text-secondary">
        <section>
          ...
          <p className="mt-3 text-sm text-text">
            本站<strong>并非安徽理工大学（AUST）官方页面</strong>，
        ...
        <section>
          <h2 className="text-lg font-serif font-semibold text-text">内容责任</h2>
        ...
        <section>
          <h2 className="text-lg font-serif font-semibold text-text">外部链接</h2>
          <p className="mt-3 text-sm text-text">
        ...
        <section>
          <h2 className="text-lg font-serif font-semibold text-text">知识产权</h2>
          <p className="mt-3 text-sm text-text">
        ...
        <section>
          <h2 className="text-lg font-serif font-semibold text-text">联系方式</h2>
          <p className="mt-3 text-sm text-text">
            如需就本站内容与站长联系，请通过{" "}
