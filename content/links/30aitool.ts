...
export const groups: LinkGroup[] = [
  // ===== 工具类（源自 30aitool.com/tools）=====
  {
    ...
    items: [
      ...
      { title: "直播录制", url: "https://github.com/chenfan0/fideo-live-record", description: "支持多平台直播自动录制，傻瓜操作", tag: "开源", tags: ["直播","本地"] },
  ...
  // ===== 电脑课（源自 30aitool.com/ilovemycomputer）=====
  {
    ...
    items: [
      ...
      { title: "【第六课】电脑知识基础补充", url: "https://30aitool.com/ilovemycomputer", description: "电脑基础知识补充，优质科普案例", tag: "教程", tags: ["基础","科普"] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "C盘软件迁移", url: "https://github.com/imDema/FreeMove", description: "把 C 盘软件迁移到其他盘，FreeMove 开源工具", tag: "教程", tags: ["C盘","迁移"] },
      { title: "文件批量重命名", url: "https://www.advancedrenamer.com/", description: "文件批量重命名工具，省时省力高效", tag: "教程", tags: ["效率","文件"] },
      { title: "禁用应用联网", url: "https://github.com/henrypp/simplewall", description: "管控应用联网行为，防后台偷跑流量", tag: "教程", tags: ["网络","管控"] },
      { title: "暂停 Windows 更新", url: "https://www.sordum.org/9470/windows-update-blocker-v1-8/", description: "暂停 Windows 自动更新，避免打扰", tag: "教程", tags: ["系统","Windows"] },
